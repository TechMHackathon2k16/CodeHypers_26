	...
	<header id="header" class="navbar navbar-static-top">
   	...
   	<nav id="column-left" class="">
		<div id="profile">
			...
			<div><a class="dropdown-toggle" data-toggle="dropdown"><img src="images/ic_launcher.png" alt="demo demo" title="demo" class="img-circle"></a></div><h4 class="pull-right">Adarsha</h4>
		</div>
		<ul id="menu">
