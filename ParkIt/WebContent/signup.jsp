				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="text-left" style="float:left">
							<a class="btn btn-primary" href="signin.jsp"><i class="fa fa-key"></i> Go to SignIn</a>
						</div>
						<div class="text-right">
							<button type="submit" name="submit" class="btn btn-primary"><i class="fa fa-key"></i> SignUp</button>
						</div>
						</form>
					</div>
				</div>
